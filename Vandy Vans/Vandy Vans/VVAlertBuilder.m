...
+ (UIAlertView *)vanArrivingAlertWithRouteName:(NSString *)routeName andStopName:(NSString *)stopName {
    return [[UIAlertView alloc] initWithTitle:@"Van Arriving" message:[self vanArrivingAlertMessageWithRouteName:routeName andStopName:stopName] delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
}
...
+ (UIAlertView *)reminderSetAlertWithRouteName:(NSString *)routeName andStopName:(NSString *)stopName {
    ...
    return [[UIAlertView alloc] initWithTitle:@"Reminder Set" message:reminderSetMessage delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
}
...
+ (UIAlertView *)reminderAlreadyExistsAlertForStopName:(NSString *)stopName newStopName:(NSString *)newStopName delegate:(id)delegate {
    ...
    return [[UIAlertView alloc] initWithTitle:@"Reminder Already Exists" message:reminderAlreadyExistsMessage delegate:delegate cancelButtonTitle:@"Cancel" otherButtonTitles:@"Replace", nil];
}

+ (UIAlertView *)vansNotRunningAlertWithDelegate:(id)delegate {
    return [[UIAlertView alloc] initWithTitle:@"Vandy Vans Unavailable" message:@"The Vandy Vans are not currently running. Please try again after 5 PM." delegate:delegate cancelButtonTitle:@"OK" otherButtonTitles:nil];
}

+ (UIAlertView *)noArrivalPredictionsAlert {
    return [[UIAlertView alloc] initWithTitle:@"No Predictions" message:@"There are no arrival predictions at this time." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
}
